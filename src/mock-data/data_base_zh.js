let base = {
    ...
    skills: {
        sectionName: '技能栈',
        description: '我是一名互联网产品经理，时刻关注互联网下的产品生态和用户体验。同时我掌握较出色的Web开发能力，他们帮助我在原型设计和团队沟通中更加高效地沟通。',
        ...
        allWorks: [
            ...
            },
            {
                ...
                descrip: [
                    ...
                    {
                        content: `此项目目的在于弥补在美留学生对于美国教育机构中保险知识体系认知欠缺的网站 。前期我们通过调查发现国际学生通常在遭遇医疗事务时的疑惑和焦虑，此项目从三个角度入手提供服务：`,
                        type: 'text',
                    },
                    {
                        content: `基本的医疗保险常识`,
                    ...
                    {
                        content: `常见的使用医疗保险的场景`,
                        type: 'text',
                    },
                    {
                        content: `，以及个性化定制的“医疗计划备忘录/记事本”`,
                        type: 'text',
                    },
                    {
                        content: `最大程度地满足用户的对于医疗保险制度知识快速上手和应用的需求痛点。`,
                        type: 'text',
                    },
                    {
            ...
            },
            {
                ...
                descrip: [
                    {
                        content: `<p class="t-center">使用原生JS开发，主要利用HTML 5的Canvas API ，是我在学习原生 JS 及 Canvas 过程中开发的小工具。 其提供在 PC 及 手机端在线画画、橡皮擦、画笔调色、画作删除等功能，并支持画作下载。</p>`,
                        type: 'text',
                    },
                    {
            ...
            },
            {
                ...
                descrip: [
                    {
                        content: `一款通过棋盘和卡片策略以帮助学生训练编程思维的卡片桌游。针对市场对于青少年幼儿编程的需求，我们前期研究了市面上近10家编程类棋牌游戏，分别对比和梳理各自的优缺点。通过编程中最基础的几种思想：循环控制，条件控制和组合性，实现游戏可玩性和教育性的最大化。设计过程严格遵守MDA（Mechanism, Dynamics, Athetics）设计原则，力求产品UI对于目标人群具有吸引力。
                        `,
                        type: 'text',
                    },
                    {
            ...
            },
            {
                ...
                descrip: [
                    ...
                    {
                        content: `食品信息通过自己搭建的RESTful API获取，后端将数据存储于MongoDB。使用React+Redux作前端UI展示，Axios发送请求，借鉴Styled-component组件样式开发思想。`,
                        type: 'text'
                    },
                ],
            ...
            },
            {
                ...
                descrip: [
                    ...
                    {
                        content: `该项目使用React实现了一个在线博客分享的平台。包含首页、用户文章列表、个人管理等页面，实现了登录、注册、编 辑、发布等功能。项目以Create-React-App为基础创建项目模版，使用Style-Component为CSS组件开发思想，使用Ant Design作UI交互。通过React Router实现路由跳转，通过Redux实现状态管理，用Axios获取数据。后端使用Node Express框架 +MongoDB数据库搭建RESTful API服务，使用JWT进行鉴权。前后端分离开发，使用Heroku部署。`,
                        type: 'text'
                    }
                ],
            ...
            },
            {
                name: '新泽西火车票造假系统',
                star: true,
                img: 'https://res.cloudinary.com/shuaiyuan/image/upload/v1552446542/cv-img/work/nj-transit/nj-transit.png',
                id: 3,
                link: {
                    preview: "https://sy2729.github.io/nj-transit/dist/",
                    repo: "https://github.com/sy2729/nj-transit"
                },
                descrip: [
                    {
                        content: `严肃声明：此为个人练习作品，不为违反犯罪的逃票行为，不承担一切法律后果。`,
                        type: 'text'
                    },
                    {
                        content: `使用原生JS实现新泽西火车票原生APP电子车票界面。`,
                        type: 'text'
                    },
                    {
                        content: `美国的火车上检票都是依靠诚信的，买了电子票的乘客只需要将票给检票员看一眼即可。很多时候检票员的眼睛停留在一张电子票上的时间甚至不过一秒，那么他们是怎么确认这张票是否是正确的真票呢？`,
                        type: 'text'
                    },
                    {
                        content: `原来每一张票上都会有三个闪动的颜色条，每张票上的闪动条的颜色都是一样的。因此检票员只需要确认这张票具有当天的三种颜色（每天是随机生成的）并且是一张“闪动的动图即可”`,
                        type: 'text'
                    },
                    {
                        content: `所以一天在下班回家的路上，我便心血来潮开发了这个界面，可以分别输入三个条的颜色，这样每天往返交通的人即可通过早上的票用一些手机APP分别提取出三个闪动条中的颜色再输入进框中，实现电子票界面完美的还原，展现给检票员查看。`,
                        type: 'text'
                    },
                    {
                        content: `项目使用使用REM实现各移动端的完美适配，使用Parcel打包`,
                        type: 'text'
                    },
                    {
                        content: 'https://res.cloudinary.com/shuaiyuan/image/upload/v1552446542/cv-img/work/nj-transit/nj-transit.png',
                        type: 'img'
                    }
                ],
                tags: ['jQuery', 'Parcel', 'Sass','REM'],
                type: 'Web',
            },
        ]
    },
