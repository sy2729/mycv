...
let cvData = {
    ...
    skills: {
        sectionName: '技能栈',
        description: "我是一名对互联网产品和新事物充满好奇、热情和想象力的互联网爱好者。较于传统的产品的开发，我对于互联网社区产品以及视频为形式的媒体产品有着更深的理解和想法。我在原型设计,UI交互和前端开发方面也曾积累了一些经验,时刻保持对审美的高度追求和严苛标准,我始终要求自己能够在和团队和客户的协作中准确地表达自己的想法。要一起做出真正的产品，必然在每个环节打磨完美，同时对时代趋势和行业风口保持理性分析和全局认知。<br>此外,我认为自己应聘马蜂窝的优势不仅在于个人能力方面，也在于我本身对于旅游文化的热爱，特别是对于旅游视频的拍摄。\
        <br> \
            第一次遇见马蜂窝，是因为这个<a target='_blank' href='https://www.youtube.com/watch?v=GVvzgzU1_Gc' style='text-decoration: underline'>视频</a>，给了我很深刻的印象。\
        ",
        allSkills: [
            {
