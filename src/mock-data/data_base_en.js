    ...
    let base = {
        ...
        works: {
            ...
            allWorks: [
                ...
                {
                    name: 'Laodianwei Noodle Restaurant Homepage',
                    ...
                    descrip: [
                        {
                            content: `This is the homepage of the restaurant that I made for my friend`,
                            type: 'text'
                        },
                        {
                        ...
                        {
                            content: `<p class="t-center">The dish item</p>`,
                            type: 'text'
                        },
                        {
                        ...
                        {
                            content: `The food's information is obtained from a self-created RESTful API, while the thumbs-up data is linked with MongoDB, the server is deployed on heruku`,
                            type: 'text'
                        },
                    ],
                ...
                },
                {
                    ...
                    descrip: [
                        {
                            content: `This is a blog platform with front-end and back-end funcitionality.`,
                            type: 'text'
                        },
                        {
                        ...
                        {
                            content: `For Front-End, I used React.js and Redux as the view layer and data modeler.`,
                            type: 'text'
                        },
                        {
                            content: `For Back-End, I user Express.js to built the MVC, used Mongoose with MongoDB as the database, and used JSON Web Token to accomplish the user authentication.`,
                            type: 'text'
                        },
                    ],
                ...
                },
                {
                    ...
                    descrip: [
                        {
                            content: `I made this video when working in Atos. Using some footages provided by clients that were not so satisfying, integreting a lot animation to beautify it.`,
                            type: 'text',
                        },
                        {
                            content: {
                ...
                {
                    name: 'Wechat App Marketing Video',
                    ...
                    descrip: [
                        {
                            content: `Made this video for the wechat-miniapp I made in the the course called Mobile Learning at Teachers College`,
                            type: 'text',
                        },
                        {
                            content: {
                ...
                {
                    name: 'Teachers College Graduation Ceremony 2018',
                    ...
                    descrip: [
                        {
                            content: `Made this video When I worked in the Web Office at Teachers College as a volunteer.`,
                            type: 'text',
                        },
                        {
                            content: {
                ...
                },
                {
                    ...
                    descrip: [
                        {
                            content: `Just a vlog for her trip in Miami`,
                            type: 'text',
                        },
                        {
                            content: {
