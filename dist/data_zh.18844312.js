...
var cvData = {
    ...
    experiences: {
        ...
        allExperiences: [{
            ...
            activeState: true,
            detail: {
                descrip: ['作为委员会和干事参加哥伦比亚大学中国学生会的一系列活动', "作为公共媒体部门的干事参与学生学者联合会的媒体宣传和制作事物，同时参与官网的维护和建设"]
            }
        }, {
            ...
            activeState: false,
            detail: {
                descrip: ["使用 Gulp 构建工具负责公司新 Landing page 开发", "使用 Element UI 结合 Vue.js 负责用户操作系统界面美化和修改，开发少数组件", "使用 Bootstrap 框架修改公司旧 Landing page", "和产品经理以及后端工程师沟通协作，完善用户体验"]
            }
        }, {
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js","data_zh.js"], null)
//# sourceMappingURL=/data_zh.18844312.map